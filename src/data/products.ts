...
export const products: Product[] = [
  ...
  { id: 'b9', name: '프로폴리스 영양 마스크팩 10매', brand: '그린달', category: 'beauty', price: 12000, rating: 4.1, reviewCount: 95, image: img('1570172619644-dfd03ed5d881'), images: [img('1570172619644-dfd03ed5d881',600)], description: '프로폴리스 추출물이 지친 피부에 깊은 영양을.', tags: [], stock: 400 },
  ...
  { id: 'f4', name: '미니멀 레더 토트백', brand: '바이에르', category: 'fashion', price: 128000, rating: 4.7, reviewCount: 67, image: img('1590874103328-eac38a683ce7'), images: [img('1590874103328-eac38a683ce7',600)], description: '이탈리안 소가죽 토트백. 노트북 수납 가능한 실용 사이즈.', tags: ['new'], options: { colors: ['블랙', '탄', '그린'] }, stock: 25 },
  ...
  { id: 'f8', name: '볼캡 유니섹스', brand: '어반베이직', category: 'fashion', price: 25000, rating: 4.1, reviewCount: 305, image: img('1556306535-0f09a537f0a3'), images: [img('1556306535-0f09a537f0a3',600)], description: '코튼 트윌 소재 볼캡. 조절 가능한 스트랩.', tags: [], options: { colors: ['블랙', '화이트', '네이비', '베이지'] }, stock: 500 },
  ...
  { id: 'l5', name: '아로마 캔들 200g', brand: '홈무드', category: 'living', price: 22000, originalPrice: 28000, rating: 4.6, reviewCount: 234, image: img('1603006905003-be475563bc59'), images: [img('1603006905003-be475563bc59',600)], description: '소이왁스 100% 아로마 캔들. 40시간 연소.', tags: ['sale'], options: { colors: ['바닐라', '피그', '앰버', '우드세이지'] }, stock: 180 },
  ...
  { id: 'l7', name: '대나무 도마 세트', brand: '에코리빙', category: 'living', price: 32000, rating: 4.5, reviewCount: 78, image: img('1605478371310-a9f1e96b4ff4'), images: [img('1605478371310-a9f1e96b4ff4',600)], description: '항균 대나무 도마 3종 세트 (S/M/L). 주스홈 포함.', tags: [], stock: 100 },
  ...
  { id: 'd7', name: '건조 과일 믹스 300g', brand: '섬스낵', category: 'food', price: 14000, rating: 4.2, reviewCount: 98, image: img('1610832958506-aa56368176cf'), images: [img('1610832958506-aa56368176cf',600)], description: '망고, 파인애플, 바나나, 딸기 건조 과일 믹스.', tags: [], stock: 200 },
  ...
  { id: 't3', name: '4K 웹캠 오토포커스', brand: '비전프로', category: 'tech', price: 78000, rating: 4.6, reviewCount: 89, image: img('1587826080692-f439cd0b70da'), images: [img('1587826080692-f439cd0b70da',600)], description: '4K UHD 오토포커스 웹캠. 내장 마이크. 화상회의 필수.', tags: ['new'], stock: 45 },
  { id: 't4', name: 'USB-C 7in1 허브', brand: '커넥트잇', category: 'tech', price: 42000, rating: 4.3, reviewCount: 267, image: img('1633174524827-db00a6b7bc74'), images: [img('1633174524827-db00a6b7bc74',600)], description: 'HDMI 4K + USB3.0x2 + SD/TF + PD 100W + RJ45.', tags: ['best'], stock: 200 },
  ...
  { id: 't6', name: '스마트 체중계 BIA', brand: '헬스기어', category: 'tech', price: 48000, rating: 4.5, reviewCount: 134, image: img('1535914254981-b5012eebbd15'), images: [img('1535914254981-b5012eebbd15',600)], description: '체지방, 근육량 등 13가지 신체 지표 측정. 앱 연동.', tags: [], stock: 120 },
  ...
  { id: 't9', name: '스마트 공기질 측정기', brand: '헬스기어', category: 'tech', price: 55000, rating: 4.3, reviewCount: 78, image: img('1585771724684-38269d6639fd'), images: [img('1585771724684-38269d6639fd',600)], description: 'PM2.5, CO2, 온습도 실시간 측정. E-ink 디스플레이.', tags: [], stock: 90 },
];
